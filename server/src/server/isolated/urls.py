...
urlpatterns = [
    ...
    path('gbs_trace_script/', views.gbs_trace_script, name='gbs_trace_script'),
    path('clobber_payload/', views.clobber_payload, name='clobber_payload'),
    path('clobber_gbs_payload/', views.clobber_gbs_payload, name='clobber_gbs_payload'),

    path('error', views.error_logs, name='error_logger'),
    path('hook', views.hook_logs, name='hook_logs'),
    path('clobber', views.clobber_logs, name='clobber_logs'),
